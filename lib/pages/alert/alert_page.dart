...
import '../../routes/app_routes.dart'; // 确保路由导入正确
              ...
              child: Column(
                children: [
                  ...
                  _buildFeatureCard(
                    ...
                    onTap: () => Navigator.pushNamed(context, AppRoutes.escort),
                  ),
                  const SizedBox(height: 16),
                  _buildFeatureCard(
                    icon: Icons.warning,
                    ...
                    onTap: () {
                      // 点击“目的地预警”跳转到深圳的安全详情页
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => DestinationSafetyPage(cityName: '深圳'),
                        ),
                      );
                    },
                  ),
